...
<p>Mi primer proyecto iniciado por mi desde cero en React-Redux, si bien no está perfecto fue mi primer aplicación funcional y la quiero conservar de recuerdo ☺️ porque  marca el incio de una gran pasión.</p>
...
<p>El proyecto FSGuide (Full Stack Guide) surge como parte de mi experiencia como Teaching Assistant dentro del Henry Bootcamp donde acompañamos a los alumnos iniciantes en todo el proceos del bootcamp, donde encontré la necesidad de contar con una plataforma con información de referencia para poder facilitar el ingreso de los alumnos al mundo del Full Stack developer</p>
